...
DbHistorical = 'BTCUSDTHistorical'
DbRealTime = 'BTCUSDT'
engineHistorical = sqlalchemy.create_engine('sqlite:///BTCUSDTHistorical.db')
engineRealTime = sqlalchemy.create_engine('sqlite:///BTCUSDT.db')
# # Zsombi
